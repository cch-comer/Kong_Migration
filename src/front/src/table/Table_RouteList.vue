    ...
    <table class="service-table">
      ...
      <tbody>
        ...
        >
          ...
          <td>
            <span v-if="data.protocols === null">-</span>
            <span
                v-for="protocol in data.protocols"
                :key="protocol"
                class="protocol-path"
            >{{ protocol }}</span>
          </td>
          <td>
            <span v-if="data.hosts === null">-</span>
            <span v-else>{{ data.hosts }}</span>
          </td>
          <td>
            <span v-if="data.methods === null">-</span>
            <span
          ...
          <td>
            <span v-if="data.paths === null">-</span>
            <span
